...
Main() {
    ...
    case "$ISO_VERSION" in
        ...
        2024.09.22) # Endeavour_Neo
            ...
            # reiserfsprogs removed from repos
        ...
        2025.03.19) # Mercury_Neo
            ...
            wget -qN -P "/tmp/" "https://raw.githubusercontent.com/endeavouros-team/ISO-hotfixes/main/netinstall.yaml-Mercury_neo.patch"
            patch "/etc/calamares/modules/netinstall.yaml" < "/tmp/netinstall.yaml-Mercury_neo.patch"
            ;;
        *)
